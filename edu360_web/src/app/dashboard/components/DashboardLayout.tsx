...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[var(--background-light)] text-[var(--foreground-light)] dark:bg-[var(--background-dark)] dark:text-[var(--foreground-dark)]">
      <aside className="flex w-64 flex-shrink-0 flex-col justify-between border-r border-[var(--border-light)] bg-[var(--card-light)] p-6 dark:border-[var(--border-dark)] dark:bg-[var(--card-dark)]">
        <div>
      ...
      <div className="flex flex-1 flex-col">
        <header className="sticky top-0 z-10 flex h-20 items-center justify-between border-b border-[var(--border-light)] bg-[rgba(246,246,248,0.85)] px-8 backdrop-blur-sm dark:border-[var(--border-dark)] dark:bg-[rgba(17,21,33,0.85)]">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="rounded-full p-2.5 text-[var(--muted-light)] transition-colors hover:bg-[rgba(21,53,147,0.1)] hover:text-[var(--primary)] dark:text-[var(--muted-dark)] dark:hover:bg-[rgba(21,53,147,0.2)] dark:hover:text-[var(--primary)]">
            ...
            <div
              className="h-10 w-10 rounded-full border-2 border-[var(--primary)] bg-cover bg-center"
              style={{
                backgroundImage:
        ...
        <main className="flex-1 overflow-y-auto bg-[var(--background-light)] p-8 dark:bg-[var(--background-dark)]">{children}</main>
      </div>
    </div>
  );
}
