        ...
        <div className="mx-auto w-full max-w-5xl 2xl:max-w-6xl">
            <div className="mb-6 flex flex-col gap-2">
                ...
                <h2 className="text-2xl font-bold 2xl:text-3xl">
                    Asistente de Importación de Profesores
                </h2>
                <p className="text-lg text-[var(--muted-light)] dark:text-[var(--muted-dark)]">
                    Siga los pasos para importar sus profesores desde un archivo CSV.
                </p>
            </div>
                            ...
                            <div>
                                ...
                                <div className="mt-2 space-y-1 text-sm text-[var(--muted-light)] dark:text-[var(--muted-dark)]">
                                    ...
                                    <p>
                                        ...
                                        Finalice el proceso para importar los profesores.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="rounded-xl border border-[var(--border-light)] bg-[var(--card-light)] p-8 text-center shadow-lg transition-all dark:border-[var(--border-dark)] dark:bg-[var(--card-dark)]">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="max-w-md text-lg text-[var(--muted-light)] dark:text-[var(--muted-dark)]">
                            El archivo ha sido procesado y los profesores han sido agregados a la plataforma.
                        </p>
                        ...
                        <div className="mt-6 flex flex-col gap-4 divide-y divide-[var(--border-light)] dark:divide-[var(--border-dark)] sm:flex-row sm:divide-x sm:divide-y-0">
                            <div className="px-6 py-2 text-center">
                                <p className="text-2xl font-bold text-[var(--primary)]">15</p>
                                <p className="text-sm text-[var(--muted-light)] dark:text-[var(--muted-dark)]">Nuevos profesores creados</p>
                            </div>
                            <div className="px-6 py-2 text-center">
                                <p className="text-2xl font-bold text-[var(--primary)]">5</p>
                                <p className="text-sm text-[var(--muted-light)] dark:text-[var(--muted-dark)]">Profesores actualizados</p>
                            </div>
                            <div className="px-6 py-2 text-center">
                        ...
                        <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                            <a href="/dashboard/teachers" className="flex items-center justify-center gap-2 rounded-lg bg-[var(--primary)] px-6 py-3 text-base font-semibold text-white shadow-sm hover:brightness-110">
