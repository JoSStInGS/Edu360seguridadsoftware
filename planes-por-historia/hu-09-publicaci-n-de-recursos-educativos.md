...
## HU-09 - Publicación de recursos educativos {#hu-09-publicaci-n-de-recursos-educativos}

**Epica:** Épica E — Recursos educativos y Classroom
**Prioridad:** Media
**Historia de usuario:** Como profesor, quiero publicar recursos educativos asociados a una materia, sección o subgrupo, para centralizar materiales de estudio disponibles para mis estudiantes autorizados.
**Dependencias:** HU-25.; HU-16.
**Etiquetas:** resources, teacher, storage, --
...
- [ ] Crear o validar manualmente buckets, permisos y limites de archivos cuando no esten cubiertos por migracion: Guardar archivo en Supabase Storage y registro en PostgreSQL.
- [ ] Crear o validar manualmente buckets, permisos y limites de archivos cuando no esten cubiertos por migracion: Storage policies por centro, materia y propietario.
...
- [ ] CA-01: El profesor debe poder crear un recurso asociado a una materia o grupo que le pertenezca. | Evidencia requerida: prueba automatizada o paso manual documentado que demuestre este comportamiento.
- [ ] CA-02: El sistema debe soportar al menos PDF, documentos ofimáticos, presentaciones y enlaces externos. | Evidencia requerida: prueba automatizada o paso manual documentado que demuestre este comportamiento.
- [ ] CA-03: El profesor debe definir el alcance del recurso antes de publicarlo. | Evidencia requerida: prueba automatizada o paso manual documentado que demuestre este comportamiento.
- [ ] CA-04: El recurso publicado debe almacenar autor, fecha, destino y tipo. | Evidencia requerida: prueba automatizada o paso manual documentado que demuestre este comportamiento.
- [ ] CA-05: Si el archivo excede restricciones configuradas o falla la carga, el sistema debe informar el error. | Evidencia requerida: prueba automatizada o paso manual documentado que demuestre este comportamiento.

### Etapa 9 - Cierre Definition of Done
- [ ] Flujo de publicación disponible. | Marcar solo con evidencia: PR, test, captura, migracion, log de comando o validacion manual.
- [ ] Storage y metadatos persistidos correctamente. | Marcar solo con evidencia: PR, test, captura, migracion, log de comando o validacion manual.
- [ ] Validación de pertenencia docente aplicada. | Marcar solo con evidencia: PR, test, captura, migracion, log de comando o validacion manual.
- [ ] Mensajes de error de carga contemplados. | Marcar solo con evidencia: PR, test, captura, migracion, log de comando o validacion manual.
- [ ] Pruebas de archivos y destino académico ejecutadas. | Marcar solo con evidencia: PR, test, captura, migracion, log de comando o validacion manual.
